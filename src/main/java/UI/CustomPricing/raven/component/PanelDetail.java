package UI.CustomPricing.raven.component;

import UI.CustomPricing.raven.shadow.ShadowRenderer;
import UI.CustomPricing.raven.swing.Button;
import UI.CustomPricing.raven.swing.List;
...
public class PanelDetail extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        int radius = 25;
        g2.setColor(Color.decode("#fafaf9"));
//        g2.setColor(new Color(250, 250, 250));
        ...
        g.setColor(Color.decode("#fafaf9"));
