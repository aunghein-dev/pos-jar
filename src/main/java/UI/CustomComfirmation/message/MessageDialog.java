package UI.CustomComfirmation.message;
...
import UI.CustomComfirmation.swing.ButtonCustom;
import UI.CustomComfirmation.swing.Glass;
...
public class MessageDialog extends javax.swing.JDialog {
    ...
    private void init() {
        ...
        animator.setResolution(10); // Higher resolution for smoother updates
    ...
    private void initComponents() {
        ...
        lbTitle.setFont(new Font("Noto Sans Myanmar", Font.PLAIN, 16));
        lbTitle.setForeground(new java.awt.Color(245, 71, 71));
        lbTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbTitle.setText("Message Title");

        txt.setEditable(false);
        txt.setFont(new Font("Noto Sans Myanmar", Font.PLAIN, 14));
