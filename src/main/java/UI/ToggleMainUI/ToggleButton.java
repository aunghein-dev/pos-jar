package UI.ToggleMainUI;

import UI.ToggleShadow.ShadowRenderer;
...
public class ToggleButton extends JComponent {
    ...
    // Add this to ToggleButton.java
    public void addToggleSelectedListener(Consumer<Boolean> listener) {
        addEventToggleSelected(new ToggleListener() {
            @Override
